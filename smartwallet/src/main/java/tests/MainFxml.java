...
public class MainFxml extends Application {
    ...
    public void showWalletLayout() { loadScene("/fxml/admin/layout/wallet_layout.fxml"); }
    ...
    public Stage openWalletLayoutPopup() {
        ...
        return openPopup("/fxml/admin/layout/wallet_layout.fxml", "My Wallet", 1100, 700, true);
    }
