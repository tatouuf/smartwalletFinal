...
public class Planning {
    ...
    private Double pourcentageEpargne;
    ...
    public Double getPourcentageEpargne() {
        return pourcentageEpargne;
    }

    public void setPourcentageEpargne(Double pourcentageEpargne) {
