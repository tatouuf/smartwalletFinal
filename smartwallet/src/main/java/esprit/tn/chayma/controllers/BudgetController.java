...
public class BudgetController {
    ...
    @FXML private TextField montantMaxField;
    ...
    @FXML private ListView<Budget> budgetsList;
    ...
    public void initialize() {
        ...
        if (Session.getCurrentUser() != null) {
            ...
            currentUserId = 1; // fallback (à adapter)
        }
        ...
        // Mois et années
        for (int i = 1; i <= 12; i++) moisCombo.getItems().add(String.valueOf(i));
        for (int i = 2024; i <= 2028; i++) anneeCombo.getItems().add(String.valueOf(i));

        // Affichage personnalisé dans la ListView
        budgetsList.setCellFactory(lv -> new ListCell<>() {
            ...
            protected void updateItem(Budget b, boolean empty) {
                ...
                if (empty || b == null) setText(null);
                    ...
                    String period = (b.getMois() != null && b.getAnnee() != null) ?
                            String.format(" (%02d/%d)", b.getMois(), b.getAnnee()) : "";
                    setText(String.format("%s - %.2f DT%s",
                            b.getCategorie() != null ? b.getCategorie() : "(aucune)",
                            b.getMontantMax(), period));
                }
            }
        });
    ...
    private void loadBudgets() {
        budgetsObservable.setAll(budgetService.getAllByUser(currentUserId));
