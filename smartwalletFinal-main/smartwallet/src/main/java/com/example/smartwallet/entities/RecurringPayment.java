...
public class RecurringPayment {
    ...
    public RecurringPayment(int id, int userId, int profileId, String name, double amount,
    ...
    public RecurringPayment(int userId, int profileId, String name, double amount,
                            Frequency frequency, LocalDate nextPaymentDate, boolean active) {
        this.userId = userId;
        this.profileId = profileId;
        this.name = name;
