...
public class ModifierService {
    ...
    @FXML private Button retouritafmod;  // À ajouter avec les autres @FXML
    ...
    private void retourMain() {
        try {
            ...
            e.printStackTrace();
            new Alert(Alert.AlertType.ERROR, "Impossible de retourner").showAndWait();
        }
    }
    ...
    // Add this method to ModifierService.java
    @FXML
    private void choisirImage() {
        ...
        try {
            ...
            new Alert(Alert.AlertType.INFORMATION, "Image uploaded successfully").showAndWait();
        } catch (IOException e) {
            e.printStackTrace();
            new Alert(Alert.AlertType.ERROR, "Error copying image").showAndWait();
        }
    }
}